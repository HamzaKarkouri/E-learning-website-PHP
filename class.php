...
<div class="texto">Ajouter un cours</div>
<div class="pluus1"><img class="pluus" src="images/pluus2.png" alt=""></div>
</div>
 <div class="boxs">
...
if($result){
  ...
  while($row = mysqli_fetch_assoc($result)){
   ...
   echo "<img src='images/del.png' class='delcours' alt='Supprimer'><input type='submit' value='' class='supcours' onclick='confirmer(".$row['idcours'].")'><form action='operationn.php' method='post'><input type='submit' name='courss' class='box7'  value='".$row['nomcours']."' onclick='display(".$row['idcours'].")'>
